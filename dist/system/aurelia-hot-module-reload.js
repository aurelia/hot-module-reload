System.register(["aurelia-pal", "aurelia-metadata", "aurelia-templating", "aurelia-dependency-injection", "./hmr-css-resource", "./view-model-traverse-controller", "./view-traverse-controller", "./render-utils"], function (exports_1, context_1) {
    "use strict";
    ...
    exports_1("getAuElements", getAuElements);
    ...
    return {
        setters: [
            ...
            function (hmr_css_resource_1_1) {
                hmr_css_resource_1 = hmr_css_resource_1_1;
            },
            function (view_model_traverse_controller_1_1) {
                view_model_traverse_controller_1 = view_model_traverse_controller_1_1;
            },
            function (view_traverse_controller_1_1) {
                view_traverse_controller_1 = view_traverse_controller_1_1;
            },
            function (render_utils_1_1) {
                render_utils_1 = render_utils_1_1;
            }
        ],
        execute: function () {
            UndefinedResourceModule = { id: null, mainResource: { metadata: {}, value: undefined } };
            HmrContext = /** @class */ (function () {
            ...
            exports_1("HmrContext", HmrContext);
        }
    };
});
